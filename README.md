...
### **_2. Moire - каталог премиального белья (VUE-3, Tailwind CSS)_**
...
### **_3. PHOTO - портфолио имеджмейкера (GreenSock)_**

> Одноэкранный сайт с анимацией при загрузке сайта и открытия бургерного меню.
...
- Перенос сайта с локального сервера на хостинг, особоенности настройки.
...
(без взаимодействия с сервером с ограниченным функционалом)
...
- Поиск с автодополнением, переход из окна поиска в таблицу с клавиатуры.
...
### **_Lagoona - каталог отелей (HTML, CSS)_**
...
### **_Euclid - строительная компания (HTML, CSS)_**
...
### **_Tehnozavr - интернет-магазин (VUE-2)_**
...
### **_MAMOD - форму регистрации (VUE-2)_**
...
- Реализовать функциональность отправки данных моковым POST запросом со следующими параметрами:
  ...
  ```
- Интерактивно отработать ошибку невведённых данных (подсветка поля, надпись под ним и тп.).
